...
saveCouponfrom(form: any) {
    ...
    if (this.coupon.total_coupon <= 48) {
      ...
      this.dialog.error('Can not Generate more than 48 coupon codes at once!');
      this.loading_list = false;
...
deleteCoupon(id) {
  ...
  generateCoupon = (form: any) => {
    ...
    //   this.dialog.error('Coupon cann\'t generated. Update Mechanic and retailer points in product master!');
    //   return;
    // }
